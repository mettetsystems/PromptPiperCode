...
Pure data types and enums for the prompt workflow. No I/O, no HTTP — safe to import from tests and services.
...
| `requirement_card.py` | Structured intake fields (objective, audience, constraints, …) |
...
| `registry.py` | Registry metadata shapes |
...
These models are the contract between clarification, draft generation, optimization, and export.
