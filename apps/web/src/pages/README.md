...
| `NewSessionPage.tsx` | `/sessions/new` | Create session from initial request |
| `ClarificationPage.tsx` | `…/clarify` | Multi-select answers, model suggestions |
...
| `ExportPage.tsx` | `…/export` | Generate artifacts |
